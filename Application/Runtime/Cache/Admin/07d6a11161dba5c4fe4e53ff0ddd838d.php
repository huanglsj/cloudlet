                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            ...
                            <td>
                                <a href="<?php echo U('Super/sedit',array('id'=>$ult['id']));?>" class="name"><?php echo ($ult['username']); ?></a>
                            </td>
                            <td>
                                <?php echo ($ult['displayname']); ?>
                            </td>
                            <td>
                                <?php echo (date('Y-m-d',$ult['createtime'])); ?>
                            </td>                            
                            <td>
                                <?php echo ($ult['tel']); ?>
                            </td>
                            <td>
                                <ul class="actions">
                                    <?php if($_SESSION['pkey']['SUPER_EDIT'] == '1'): ?><li><a href="<?php echo U('Super/sedit',array('uid'=>$ult['id']));?>"><i class="table-edit"></i></a></li><?php endif; ?>
                                    <?php if($_SESSION['pkey']['SUPER_DEL'] == '1'): ?><li class="last"><a href="<?php echo U('Super/sdel',array('uid'=>$ult['id']));?>" onclick="if(confirm('确定要删除吗?')){return true;}else{return false;}"><i class="table-delete"></i></a></li><?php endif; ?>
                                </ul>
                            </td>

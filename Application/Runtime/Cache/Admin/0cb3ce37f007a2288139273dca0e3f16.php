    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
            	<form action="<?php echo U('Super/contentedit');?>" method="post">
                <!-- left column -->
                <div class="span8 column">
                    <input type="hidden" name="Id" value="<?php echo ($content["Id"]); ?>"/>
					<div class="field-box">
						<label>公告标题：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入公告标题" data-placement="right" name="title" value="<?php echo ($content["title"]); ?>"/>
					</div>
					<div class="field-box">
						<label>公告详情：</label>
						<textarea class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入公告详情" data-placement="right" name="content" ><?php echo ($content["content"]); ?></textarea>
					</div>

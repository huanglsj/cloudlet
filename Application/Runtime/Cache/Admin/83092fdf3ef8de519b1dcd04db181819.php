...
<div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    <h3  class="span12 pull-left">会员单位列表</h3>
                    <div class="span12 pull-left">
	                    <div class="tpsearch span3">
	                    	会员名：<input type="text" placeholder="请输入会员名称" name="comname" id="comname"/>
	                    </div>
	                    <div class="tpsearch span3">
	                    	会员编号：<input type="text"  placeholder="请输入会员编号" name="ccode" id="ccode"/>
	                    </div>
	                    <div class="tpsearch span3">
	                    	负责人名：<input type="text"  placeholder="负责人名" name="managername" id="managername">
	                    </div>
	                    <div class="tpsearch span3">
	                    	手机号：<input type="text"  placeholder="负责人手机号" name="managerphone" id="managerphone">
	                    </div>
	                </div>
                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="span2 sortable">
                                    <span class="line"></span>会员名
                                </th>
                                <th class="span2 sortable">
                                    <span class="line"></span>会员编号
                                </th>
                                <th class="span2 sortable">
                                    <span class="line"></span>负责人名
                                </th>
                                <th class="span2 sortable">
                                    <span class="line"></span>手机号
                                </th>
                                <th class="span2 sortable">
                                    <span class="line"></span>剩余权益
                                </th>
                                <th class="span2 sortable">
                                    <span class="line"></span>邀请码
                                </th>
                                <th class="span2 sortable">
                        ...
                        <tbody id="ajaxback">
                        <?php if(is_array($ulist)): $i = 0; $__LIST__ = $ulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ult): $mod = ($i % 2 );++$i;?><tr class="first">
                            <td>
                                <?php echo ($ult['cid']); ?>
                            </td>
                            <td>
                            	<?php echo ($ult['comname']); ?>                                
                            </td>
                            <td>
                                <?php echo ($ult['ccode']); ?>
                            </td>
                            <td>
                                <?php echo ($ult['managername']); ?>
                            </td>
                            <td>
                            	<?php echo ($ult['managerphone']); ?>
                            </td>
                            <td>
                                <?php echo ($ult['equity']); ?>
                            </td>
                            <td>
                                <?php echo ($ult['invcode']); ?>
                            </td>
                            <td>
                            	<?php switch($ult["isdelete"]): case "N": ?>有效<?php break;?>
	                            	<?php case "C": ?>冻结<?php break; endswitch;?>
                            </td>
                            <td>
                            	<ul class="actions">
                            	    <?php if($_SESSION['pkey']['MENBER_EDIT'] == '1'): ?><li><a href="<?php echo U('Menber/mupdate',array('cid'=>$ult['cid']));?>"><i class="table-edit"></i></a></li><?php endif; ?>
                                    <?php if($_SESSION['pkey']['MENBER_EQUTY_EDIT'] == '1'): ?><li><a href="<?php echo U('Menber/updateequity',array('cid'=>$ult['cid']));?>"><i class="table-settings"></i></a></li><?php endif; ?>
                                    <?php if($_SESSION['pkey']['MENBER_DEL'] == '1'): ?><li class="last"><a href="<?php echo U('Menber/userdel',array('cid'=>$ult['cid']));?>" onclick="if(confirm('确定要删除吗?请谨慎操作！')){return true;}else{return false;}"><i class="table-delete"></i></a></li><?php endif; ?>
                                </ul>
                            </td>

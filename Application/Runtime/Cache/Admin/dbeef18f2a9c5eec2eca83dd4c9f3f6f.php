...
<div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    <?php if($type == 1 ): ?><h3  class="span12 pull-left">管理员角色列表</h3><?php endif; ?>
                    <?php if($type == 2 ): ?><h3  class="span12 pull-left">会员角色列表</h3><?php endif; ?>
                </div>
                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <?php if(is_array($ulist)): $i = 0; $__LIST__ = $ulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ult): $mod = ($i % 2 );++$i;?><tr class="first">
                            ...
                            <td>
                            	<ul class="actions">
                            	<?php if($type == 1 ): if($_SESSION['pkey']['SYS_EDIT'] == '1'): ?><li><a href="<?php echo U('Super/mredit',array('uid'=>$ult['id'],'username'=>$ult['username'],'cname'=>$ult['cname'],'type'=>$ult['type']));?>"><i class="table-edit"></i></a></li><?php endif; endif; ?>
                                <?php if($type == 99 ): if($_SESSION['pkey']['MR_EDIT'] == '1'): ?><li><a href="<?php echo U('Super/mredit',array('uid'=>$ult['id'],'username'=>$ult['username'],'cname'=>$ult['cname'],'type'=>$ult['type']));?>"><i class="table-edit"></i></a></li><?php endif; endif; ?>
                                <?php if($_SESSION['pkey']['MR_EDIT'] == '1'): ?><li class="last"><a href="<?php echo U('Super/mrdel',array('uid'=>$ult['id'],'type'=>$ult['type']));?>" onclick="if(confirm('确定要删除吗?')){return true;}else{return false;}"><i class="table-delete"></i></a></li><?php endif; ?>
                                </ul>
                            </td>

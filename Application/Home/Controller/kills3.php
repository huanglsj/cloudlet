...
function getGameData($pid){
    ...
    if($pid == 37){
        $url = "http://solebillow.com/home/Api/hq_prices/code/sgbpusd";
    }elseif ($pid == 38){
        $url = "http://solebillow.com/home/Api/hq_prices/code/sgbpusd";
    }else{
        return false;
    ...
    if($result){
        ...
        $values = array(
            ...
            'recvtime'=>$now, 'dealtime'=>$result['Ltime'], 'pid'=>$pid,

            'lastClosePrice'=>$result['Sprice'], 'openPrice'=>$result['Kprice'], 'highprice'=>$result['Hprice'],

            'lowprice'=>$result['Lprice'], 'newprice'=>$result['price'], 'Volume'=>'',

            'BuyPrice'=>'','SellPrice'=>'','diff'=>$result['diffprice'],

            'diffrate'=>$result['diffcenti'],'isopen'=>1,

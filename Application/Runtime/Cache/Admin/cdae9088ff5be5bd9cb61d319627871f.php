...
<div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    <h3  class="span12 pull-left">风控设置</h3>
                </div>
                <div class="row-fluid header head2">
                    <a href="<?php echo U('Super/riskadd');?>" class="btn-flat success">
                        添加风控
                    </a>
                </div>
                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="span1 sortable">
                                	<span class="line"></span>风控名称
                                </th>
                                <th class="span2 sortable">
                                    <span class="line"></span>干预区间
                                </th>
                                <th class="span2 sortable">
                                    <span class="line"></span>获胜比率
                                </th>
                                <th class="span2 sortable">
                        ...
                        <tbody id="ajaxback">
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ult): $mod = ($i % 2 );++$i;?><tr class="first">
                            <td>
                                <?php echo ($ult['id']); ?>
                            </td>
                            <td>
                            ...
                            <td>
                            	<?php echo ($ult['price_min']); ?>元 - <?php echo ($ult['price_max']); ?>元
                            </td>
                            <td>
                                <?php echo ($ult['win_rate']); ?>
                            </td>
                            <td>
                            	<?php switch($ult["status"]): case "1": ?>开启<?php break;?>
	                            	<?php case "2": ?>关闭<?php break; endswitch;?>
                            </td>
                            <td>
                            	<ul class="actions">
                                        <li><a href="<?php echo U('Super/riskedit',array('id'=>$ult['id']));?>"><i class="table-edit"></i></a></li>
                                        <li class="last"><a href="<?php echo U('Super/riskdel',array('id'=>$ult['id']));?>" onclick="if(confirm('确定要删除吗?请谨慎操作！')){return true;}else{return false;}"><i class="table-delete"></i></a></li>
                                </ul>
                            </td>

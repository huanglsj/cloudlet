    ...
    <div id="pad-wrapper" class="users-list">
      <div class="row-fluid header">
          ...
          <div class="span10 pull-right">
              ...
              <div class="tpsearch">
              	会员编号
              	<input type="text" class="span6 search" name="deptcode" value="<?php echo ($deptcode); ?>"/>
              </div>
              <div class="tpsearch">
              	操作日期
        ...
        <div class="row-fluid table">
            <table class="table table-hover">
                ...
                <tr class="first">
                    ...
                    <td>
                        <a href="<?php echo U('mupdate',array('cid'=>$relist['cid']));?>"><?php echo ($relist["deptcode"]); ?></a>
                    </td>

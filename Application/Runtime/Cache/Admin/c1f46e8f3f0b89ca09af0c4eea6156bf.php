...
<h1>
                    ...
                    <div class="span8 column esystem">
                    	<div class="field-box" style="height: 40px">
                            ...
                            <div class="slider-frame">
                            	<span data-on-text="关闭平台"  data-off-text="开启平台" class="slider-button on" data-isopen="<?php echo ($conf["isopen"]); ?>"><?php if($conf['isopen'] == '1'): ?>开启平台<?php else: ?>关闭平台<?php endif; ?></span>
                        	</div>
                        ...
                        <div class="field-box">
                            <label>单笔最小建仓价格：</label>
                            <input class="span6" type="text" data-toggle="tooltip" data-trigger="focus" title="单笔最小建仓价格" data-placement="right" value="<?php echo ($conf["minorderamount"]); ?>" name="minorderamount"/>
                            <span class="sysset">
                            	<a class="btn-glow primary minorderamount">提交</a>
                           	</span>
                        </div>
                        <div class="field-box">
                            <label>单笔最大建仓价格：</label>
                            <input class="span6" type="text" data-toggle="tooltip" data-trigger="focus" title="单笔最大建仓价格" data-placement="right" value="<?php echo ($conf["maxorderamount"]); ?>" name="maxorderamount"/>
                            <span class="sysset">
                            	<a class="btn-glow primary maxorderamount">提交</a>
                           	</span>
                        </div>
                        <div class="field-box">
                            <label>用户最大持仓总额：</label>
                            <input class="span6" type="text" data-toggle="tooltip" data-trigger="focus" title="用户最大持仓总额" data-placement="right" value="<?php echo ($conf["maxuseramount"]); ?>" name="maxuseramount"/>
                            <span class="sysset">
                            	<a class="btn-glow primary maxuseramount">提交</a>
                           	</span>
                        </div>
						<div class="field-box">
                            <label>注册赠送券：</label>
                            <select name="registsendcp" id="registsendcp" style="margin-bottom:30px;">
                                <option value="0">未选择优惠券</option>
                                <?php if(is_array($exprInfo)): $i = 0; $__LIST__ = $exprInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cp): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cp['eid']); ?>" <?php if($cp["eid"] == $conf["registsendcp"]): ?>selected = "selected"<?php endif; ?>><?php echo ($cp['eprice']); ?>元,有效期<?php echo ($cp['limittime']); ?>天</option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                            <span class="sysset">
                            	<a class="btn-glow primary registsendbtn">提交</a>
                           	</span>
                        </div>
                        <div class="field-box">
                            <label>默认允许偏离点数：</label>
                            <input class="span6" type="text" data-toggle="tooltip" data-trigger="focus" title="默认允许偏离点数" data-placement="right" value="<?php echo ($conf["defdiancha"]); ?>" name="defdiancha"/>
                            <span class="sysset">
                                <a class="btn-glow primary setdefdianchabtn">提交</a>
                            </span>
                        </div>
    ...
    <script type="text/javascript">
        $(function () {
            <?php if($conf["isopen"] == 1): ?>$('.slider-button').removeClass('on').html($(this).data("off-text"));
	            $('.slider-frame').css('background-color','#d5dde4');
	            $('.slider-frame span	').css('color','#f00');
	            $('.setopen').addClass('on').html($('.setopen').data("on-text"));
	        <?php else: ?>
	            ...
	            $('.slider-frame').css('background-color','#468847');
	            $('.slider-frame span').css('color','#7e91aa');
	            $('.setopen').removeClass('on').html($('.setopen').data("off-text"));<?php endif; ?>

...
class WxPayApi
{
	 ...
	 *
	 * 微信企业付款
	 * @param WxMchPayOrder $inputObj
	 * @param int $timeOut
	 * @throws WxPayException
	 * @return 成功时返回，其他抛异常
	 */
	public static function mchPay($inputObj, $timeOut = 6)
	{
		...
		if(($inputObj->GetCheck_name() == "FORCE_CHECK" || $inputObj->GetCheck_name() == "OPTION_CHECK")
			...
			throw new WxPayException("统一支付接口中，缺少必填参数re_user_name！check_name为FORCE_CHECK或OPTION_CHECK时，openid为必填参数！");
		}
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function mchOrderQuery($inputObj, $timeOut = 6)
	{
		$url = "https://api.mch.weixin.qq.com/mmpaymkttransfers/gettransferinfo";
		//检测必填参数
		if(!$inputObj->IsPartner_trade_noSet()) {
			throw new WxPayException("企业付款订单查询接口中，partner_trade_no必填！");
		}
		$inputObj->SetAppid(WxPayConfig::APPID);//公众账号ID
		$inputObj->SetMch_id(WxPayConfig::MCHID);//商户号
		$inputObj->SetNonce_str(self::getNonceStr());//随机字符串

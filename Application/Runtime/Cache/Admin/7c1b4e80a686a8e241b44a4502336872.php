   ...
   <div class="container-fluid">
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    <form action="/index.php/Admin/Super/mredit.html" method="post" class="new_user_form" >
                    <!-- left column -->
                    	<input class="span4" type="hidden" name="uid" value="<?php echo ($uid); ?>"/>
                    	<input class="span4" type="hidden" name="type" value="<?php echo ($type); ?>"/>
                        <div class="span9 field-box uname">
                            <label>会员名:</label>
                            <input class="span4" type="text" name="username" value="<?php echo ($username); ?>" readonly="true"/>
                        </div>
                        <div class="span9 field-box">
                            <label>公司名称:</label>
                            <input class="span8" type="text" name="cname" value="<?php echo ($cname); ?>" readonly="true"/>
                        </div>
                        <div class="span9 field-box" id="rolecheck">
                            <label>角色选择:</label>
                            <?php if(is_array($rlist)): $i = 0; $__LIST__ = $rlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rlt): $mod = ($i % 2 );++$i;?><span style="padding-left: 10px">
                                    <input type="checkbox" class="checkedrole" name="checkedrole[]" value="<?php echo ($rlt['id']); ?>" onclick="setcheck(this)" <?php if($rlt["checked"] == "1"): ?>checked<?php endif; ?> ><?php echo ($rlt['name']); ?></input>

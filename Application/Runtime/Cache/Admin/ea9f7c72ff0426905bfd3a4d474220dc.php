        ...
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span8 column">
                	<input type="hidden" name="uid" value="<?php echo ($ult['id']); ?>"/>
					...
					<div class="field-box otherinfo">
						<label>管理员姓名：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入管理员姓名" data-placement="right" value="<?php echo ($ult['displayname']); ?>" name="displayname"/>
					</div>
					<div class="field-box otherinfo" >
						<label>管理员电话：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入管理员电话" data-placement="right" name="tel" value="<?php echo ($ult['tel']); ?>"/>
					</div>

    ...
    <div class="container-fluid">
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
            	<form action="<?php echo U('Super/editworkday');?>" method="post">
                <!-- left column -->
                <div class="span8 column">
                    <input type="hidden" name="uid" value="<?php echo ($info['uid']); ?>"/>
                    <input type="hidden" name="productpid" value="<?php echo ($info['productpid']); ?>"/>
                    <input type="hidden" name="fulldate" value="<?php echo ($fulldate); ?>"/>
                    <div class="field-box">
                        <label>日期：</label>
                        <input class="span3" type="text" name="fulldateY" value="<?php echo ($fulldateY); ?>" readonly="readonly"/>
                        <input class="span3" type="text" name="week" value="<?php echo ($weekname); ?>" readonly="readonly"/>
                    </div>
                    <div class="field-box">
                        <label>状态:</label>
                        <div class="ui-select span5">
                            <select style="width:95%" name="isworkday">
                                <option <?php if($info["isworkday"] == "0"): ?>selected<?php endif; ?> value="0">休市</option>
                                <option <?php if($info["isworkday"] == "1"): ?>selected<?php endif; ?> value="1">开市</option>
                            </select>
                        </div>
                    </div>
					<div class="field-box">
						...
						<table class='table'>
							...
							<tbody>
								<tr  class="first">
									<td>
										<?php if(is_array($period)): $i = 0; $__LIST__ = $period;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><input style="width:100%" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入交易开始时间(例子：0600（凌晨6点整）)" data-placement="right" name="tstart[]" value="<?php echo ($p["s"]); ?>"/><br><?php endforeach; endif; else: echo "" ;endif; ?>
									</td>
									<td>
										<?php if(is_array($period)): $i = 0; $__LIST__ = $period;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$p): $mod = ($i % 2 );++$i;?><input style="width:100%" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入交易结束时间(例子：0400（凌晨4点整）)" data-placement="right" name="tend[]"  value="<?php echo ($p["e"]); ?>"/><br><?php endforeach; endif; else: echo "" ;endif; ?>
									</td>
									<td>

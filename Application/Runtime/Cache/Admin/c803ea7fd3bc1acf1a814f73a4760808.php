...
<div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                ...
                <div class="row-fluid table">
				  <a href="/index.php/Admin/Super/contentadd.html" class="name">添加公告</a>
                    <table class="table table-hover">
                        ...
                        <tbody>
                        <?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ct): $mod = ($i % 2 );++$i;?><!-- row -->
                        <tr class="first">
                            <td>
                                <?php echo ($ct['Id']); ?>
                            </td>
                            <td>
                                <a href="<?php echo U('Super/contentedit',array('id'=>$ult['id']));?>" class="name"><?php echo ($ct["title"]); ?></a>
                            </td>
                            <td>
                                <?php echo ($ct["content"]); ?>
                            </td>
                            <td>
                                <?php echo ($ct["datetime"]); ?>
                            </td>                        
                            <td>
                                <ul class="actions">
                                    <?php if($_SESSION['pkey']['SUPER_EDIT'] == '1'): ?><li><a href="<?php echo U('Super/contentedit',array('Id'=>$ct['Id']));?>"><i class="table-edit"></i></a></li><?php endif; ?>
                                    <?php if($_SESSION['pkey']['SUPER_DEL'] == '1'): ?><li class="last"><a href="<?php echo U('Super/contentdel',array('Id'=>$ct['Id']));?>" onclick="if(confirm('确定要删除吗?')){return true;}else{return false;}"><i class="table-delete"></i></a></li><?php endif; ?>
                                </ul>
                            </td>

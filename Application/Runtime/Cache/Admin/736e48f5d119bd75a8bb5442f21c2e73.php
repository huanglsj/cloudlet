...
<h1>
	...
	<link href="/Public/Admin/css/zTree/zTreeStyle.css" rel="stylesheet" />
	<link href="/Public/Admin/css/zTree/demo.css" rel="stylesheet" />
	<!-- scripts -->
...
<script src="/Public/Admin/js/jquery.ztree.core-3.5.js"></script>
<script src="/Public/Admin/js/jquery.ztree.excheck-3.5.js"></script>
    <div class="container-fluid">
        <div id="pad-wrapper" class="form-page">
            ...
            <div class="row-fluid form-wrapper">
            	<form action="<?php echo U('Super/redit');?>" method="post">
                <!-- left column -->
                <div class="span8 column">
					...
					<div class="field-box">
						<label>角色名称：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入角色名称" data-placement="right" id="rname" name="rname" value="<?php echo ($info['name']); ?>"/>
					</div>
					<div class="field-box">
                        <label>角色类型:</label>
                        <input type="hidden" name="rtype" value="<?php echo ($info['rtype']); ?>"/>
                        <?php if($info["rtype"] == "1"): ?><input class="span8" type="text" value="总公司人员角色" readonly="readonly"/><?php endif; ?>
                        <?php if($info["rtype"] == "2"): ?><input class="span8" type="text" value="会员人员角色" readonly="readonly"/><?php endif; ?>
                        <?php if($info["rtype"] == "3"): ?><input class="span8" type="text" value="代理人员角色" readonly="readonly"/><?php endif; ?>
                        <?php if($info["rtype"] == "4"): ?><input class="span8" type="text" value="机构人员角色" readonly="readonly"/><?php endif; ?>
                    </div>
                    <div class="field-box">
                        <label>状态:</label>
                        <div class="ui-select span5">
                            <select style="width:95%" name="state">
                                <option <?php if($info["state"] == "1"): ?>selected<?php endif; ?> value="1">正常</option>
                                <option <?php if($info["state"] == "2"): ?>selected<?php endif; ?> value="2">无效</option>
                            </select>
                        </div>
                    </div>
                    <div class="field-box">
                        <label>设为默认角色:</label>
                        <input type="checkbox" name="isdefault" value="1" <?php if($info["isdefault"] == "1"): ?>checked<?php endif; ?> ></input>
                    </div>
					<div class="field-box">
						<label>备注：</label>
						<input class="span8" type="text" data-toggle="tooltip" data-trigger="focus" title="请输入备注信息" data-placement="right" name="remarks" value="<?php echo ($info['remarks']); ?>"/>
					</div>
					<div class="field-box">
                        <label>权限选择：</label>
...
<SCRIPT type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $.fn.zTree.init($("#tree"), setting, <?php echo ($parray); ?>);
    });
</SCRIPT>

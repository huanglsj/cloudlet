        ...
        <div id="pad-wrapper" class="users-list">
            ...
            <div class="row-fluid table">
                <table class="table table-hover">
                    ...
                    <tbody id="ajaxback">
                    <?php if(is_array($rlist)): $i = 0; $__LIST__ = $rlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rl): $mod = ($i % 2 );++$i;?><!-- row -->
                    <tr class="first">
                        <td>
                            <?php echo ($rl['id']); ?>
                        </td>
                        ...
                        <td>
                            <?php if($rl["rtype"] == 1): ?>总公司人员角色<?php endif; ?>
                            <?php if($rl["rtype"] == 2): ?>会员人员角色<?php endif; ?>
                            <?php if($rl["rtype"] == 3): ?>代理人员角色<?php endif; ?>
                            <?php if($rl["rtype"] == 4): ?>机构人员角色<?php endif; ?>
                        </td>
                        <td><?php if($rl["state"] == 1): ?>正常
                                <?php else: ?>无效<?php endif; ?>
                        </td>
                        <td><?php if($rl["isdefault"] == 1): ?>是<?php endif; ?>
                        </td>
                        <td>
                            <?php echo ($rl['remarks']); ?>
                        </td>
                        <td>
                            <ul class="actions">
                                <?php if($_SESSION['pkey']['ROLE_EDIT'] == '1'): ?><li style="border: 0;"><a href="<?php echo U('Super/redit',array('id'=>$rl['id']));?>"><i class="table-edit"></i></a></li><?php endif; ?>
                                <?php if($_SESSION['pkey']['ROLE_DEL'] == '1'): ?><li class="last"><a href="<?php echo U('Super/rdel',array('id'=>$rl['id']));?>" onclick="if(confirm('确定要删除吗?')){return true;}else{return false;}"><i class="table-delete"></i></a></li><?php endif; ?>
                            </ul>
                        </td>
